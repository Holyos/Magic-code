...
AssetManager.buildings.loadSprites(mine_modern);
...
AssetManager.buildings.loadSprites(market_alliance);
...
bonfire_rain_alliance.cost = new ConstructionCost(0, 0, 0, 80);
...
bonfire_rain_alliance.base_stats["health"] = 15000f;
...
AssetManager.buildings.loadSprites(bonfire_rain_alliance);
 ...
 BuildingAsset House_rain_alliance = AssetManager.buildings.clone("House_rain_alliance", "$building_civ_human$");
        ...
        House_rain_alliance.base_stats["health"] = 1000f;
...
Barracks_rain_alliance.base_stats["health"] = 2000f;
...
Docks_modern_alliance.boat_types = new string[12] { "cargo_alliance_boat", "destroyer_a_alliance_boat", "destroyer_b_alliance_boat", "carrier_alliance_boat", "submarine_alliance_boat", "fishing_alliance_boat", "abrawler_alliance_boat", "bbrawler_alliance_boat", "cbrawler_alliance_boat", "dbrawler_alliance_boat", "ebrawler_alliance_boat", "fbrawler_alliance_boat" };
...
Docks_modern_alliance.base_stats["health"] = 2500f;
...
AssetManager.buildings.loadSprites(Docks_modern_alliance);
...
bonfire_modern_alliance.can_be_upgraded = false;
bonfire_modern_alliance.upgraded_from = "bonfire_rain_alliance";
bonfire_modern_alliance.cost = new ConstructionCost(0, 0, 0, 200);
...
bonfire_modern_alliance.base_stats["health"] = 1000000f;
...
AssetManager.buildings.loadSprites(bonfire_modern_alliance);
 ...
 BuildingAsset House_modern_alliance = AssetManager.buildings.clone("House_modern_alliance", "$building_civ_human$");
        ...
        House_modern_alliance.base_stats["health"] = 2000f;
...
House_modern_alliance.can_be_upgraded = false;
...
AssetManager.buildings.loadSprites(House_modern_alliance);
...
Barracks_modern_alliance.base_stats["health"] = 3000f;
...
AssetManager.buildings.loadSprites(Barracks_modern_alliance);
...
AssetManager.buildings.loadSprites(watch_tower_modern_alliance);
...
AssetManager.buildings.loadSprites(market_harden);
...
bonfire_rain_harden.cost = new ConstructionCost(0, 0, 0, 80);
...
bonfire_rain_harden.base_stats["health"] = 15000f;
...
AssetManager.buildings.loadSprites(bonfire_rain_harden);
 ...
 BuildingAsset House_rain_harden = AssetManager.buildings.clone("House_rain_harden", "$building_civ_human$");
        ...
        House_rain_harden.base_stats["health"] = 1000f;
...
Barracks_rain_harden.base_stats["health"] = 2000f;
...
Docks_modern_harden.boat_types = new string[12] { "cargo_harden_boat", "destroyer_a_harden_boat", "destroyer_b_harden_boat", "carrier_harden_boat", "submarine_harden_boat", "fishing_harden_boat", "abrawler_harden_boat", "bbrawler_harden_boat", "cbrawler_harden_boat", "dbrawler_harden_boat", "ebrawler_harden_boat", "fbrawler_harden_boat" };
...
Docks_modern_harden.base_stats["health"] = 2500f;
...
AssetManager.buildings.loadSprites(Docks_modern_harden);
...
bonfire_modern_harden.cost = new ConstructionCost(0, 0, 0, 200);
...
bonfire_modern_harden.base_stats["health"] = 1000000f;
...
AssetManager.buildings.loadSprites(bonfire_modern_harden);
 ...
 BuildingAsset House_modern_harden = AssetManager.buildings.clone("House_modern_harden", "$building_civ_human$");
        ...
        House_modern_harden.base_stats["health"] = 2000f;
...
House_modern_harden.can_be_upgraded = false;
...
AssetManager.buildings.loadSprites(House_modern_harden);
...
Barracks_modern_harden.base_stats["health"] = 3000f;
...
AssetManager.buildings.loadSprites(Barracks_modern_harden);
...
AssetManager.buildings.loadSprites(watch_tower_modern_harden);
...
AssetManager.buildings.loadSprites(market_gaia);
...
bonfire_rain_gaia.cost = new ConstructionCost(0, 0, 0, 80);
...
bonfire_rain_gaia.base_stats["health"] = 15000f;
...
AssetManager.buildings.loadSprites(bonfire_rain_gaia);
 ...
 BuildingAsset House_rain_gaia = AssetManager.buildings.clone("House_rain_gaia", "$building_civ_human$");
        ...
        House_rain_gaia.base_stats["health"] = 1000f;
...
Barracks_rain_gaia.base_stats["health"] = 2000f;
...
Docks_modern_gaia.boat_types = new string[12] { "cargo_gaia_boat", "destroyer_a_gaia_boat", "destroyer_b_gaia_boat", "carrier_gaia_boat", "submarine_gaia_boat", "fishing_gaia_boat", "abrawler_gaia_boat", "bbrawler_gaia_boat", "cbrawler_gaia_boat", "dbrawler_gaia_boat", "ebrawler_gaia_boat", "fbrawler_gaia_boat" };
...
Docks_modern_gaia.base_stats["health"] = 2500f;
...
AssetManager.buildings.loadSprites(Docks_modern_gaia);
...
bonfire_modern_gaia.cost = new ConstructionCost(0, 0, 0, 200);
...
bonfire_modern_gaia.base_stats["health"] = 1000000f;
...
AssetManager.buildings.loadSprites(bonfire_modern_gaia);
 ...
 BuildingAsset House_modern_gaia = AssetManager.buildings.clone("House_modern_gaia", "$building_civ_human$");
        ...
        House_modern_gaia.base_stats["health"] = 2000f;
...
AssetManager.buildings.loadSprites(House_modern_gaia);
...
Barracks_modern_gaia.base_stats["health"] = 3000f;
...
AssetManager.buildings.loadSprites(Barracks_modern_gaia);
...
AssetManager.buildings.loadSprites(watch_tower_modern_gaia);
...
AssetManager.buildings.loadSprites(market_horde);
...
bonfire_rain_horde.cost = new ConstructionCost(0, 0, 0, 80);
...
bonfire_rain_horde.base_stats["health"] = 15000f;
...
AssetManager.buildings.loadSprites(bonfire_rain_horde);
 ...
 BuildingAsset House_rain_horde = AssetManager.buildings.clone("House_rain_horde", "$building_civ_human$");
        ...
        House_rain_horde.base_stats["health"] = 1000f;
...
Barracks_rain_horde.base_stats["health"] = 2000f;
...
Docks_modern_horde.boat_types = new string[12] { "cargo_horde_boat", "destroyer_a_horde_boat", "destroyer_b_horde_boat", "carrier_horde_boat", "submarine_horde_boat", "fishing_horde_boat", "abrawler_horde_boat", "bbrawler_horde_boat", "cbrawler_horde_boat", "dbrawler_horde_boat", "ebrawler_horde_boat", "fbrawler_horde_boat" };
...
Docks_modern_horde.base_stats["health"] = 2500f;
...
AssetManager.buildings.loadSprites(Docks_modern_horde);
...
bonfire_modern_horde.cost = new ConstructionCost(0, 0, 0, 200);
...
bonfire_modern_horde.base_stats["health"] = 20000f;
...
AssetManager.buildings.loadSprites(bonfire_modern_horde);
 ...
 BuildingAsset House_modern_horde = AssetManager.buildings.clone("House_modern_horde", "$building_civ_human$");
        ...
        House_modern_horde.base_stats["health"] = 2000f;
...
AssetManager.buildings.loadSprites(House_modern_horde);
...
Barracks_modern_horde.base_stats["health"] = 3000f;
...
AssetManager.buildings.loadSprites(Barracks_modern_horde);
...
AssetManager.buildings.loadSprites(watch_tower_modern_horde);
...
[HarmonyPatch(typeof(ActorManager), "evolutionEvent")]
    ...
    {
        private static void Postfix(Actor pOriginalActor, bool pWithBiomeEffect, bool pAscension, ref Actor __result)
        {
            ...
            var buildOrderMap = new Dictionary<string, string>
            {
                ...
                {"unicorn", "build_order_gaia_epochs"},
                {"miniciv_unicorn", "build_order_gaia_epochs"},
            ...
            try {
                Debug.Log($"evo detected: {pOriginalActor.asset.id} -> {__result.asset.id}");

                if (pOriginalActor.asset.id == "lemon_snail" || pOriginalActor.asset.id == "crystal_sword") {
                    Debug.Log($"evolution case: {pOriginalActor.asset.id} -> {__result.asset.id}");
                }
            } catch (Exception ex) {
                Debug.LogError($"evolution: {ex.Message}");
            }

            if (__result.asset != null)
            {
                string id = __result.asset.id;
                if (buildOrderMap.TryGetValue(id, out string buildOrderTemplate))
                {
                    try {
                        ...
                        if (asset != null)
                        {
                            Debug.Log($"Setting build order template for {id} to {buildOrderTemplate}");

                            asset.build_order_template_id = buildOrderTemplate;

                            __result.setAsset(asset);

                            Debug.Log($"build order template for {id}");
                        }
                    } catch (Exception ex) {
                        Debug.LogError($"no setting build order template for {id}: {ex.Message}");
                    }
                }
            }
        }
...
public static class Patch_CustomBuildOrder
{
    public static bool Prefix(BuildOrder __instance, City pCity, string pOrderID, ref BuildingAsset __result)
    {
        ...
        else if (order == "order_bonfire_modern_alliance")
        {
            __result = AssetManager.buildings.get("bonfire_modern_alliance");
            return false;
        }
        else if (order == "order_bonfire_rain_alliance")
        {
            __result = AssetManager.buildings.get("bonfire_rain_alliance");
            return false;
        }
        else if (order == "order_barracks_rain_alliance")
        {
            __result = AssetManager.buildings.get("Barracks_rain_alliance");
            return false;
        }
        else if (order == "order_house_rain_alliance")
        {
            __result = AssetManager.buildings.get("House_rain_alliance");
            return false;
        }
        else if (order == "order_market_alliance")
        {
            __result = AssetManager.buildings.get("market_alliance");
            return false;
        }
        else if (order == "order_bonfire_modern_gaia")
        {
            __result = AssetManager.buildings.get("bonfire_modern_gaia");
            return false;
        }
        else if (order == "order_bonfire_rain_gaia")
        {
            __result = AssetManager.buildings.get("bonfire_rain_gaia");
            return false;
        }
        else if (order == "order_barracks_rain_gaia")
        {
            __result = AssetManager.buildings.get("Barracks_rain_gaia");
            return false;
        }
        else if (order == "order_house_rain_gaia")
        {
            __result = AssetManager.buildings.get("House_rain_gaia");
            return false;
        }
        else if (order == "order_market_gaia")
        {
            __result = AssetManager.buildings.get("market_gaia");
            return false;
        }
                else if (order == "order_bonfire_modern_harden")
        {
            __result = AssetManager.buildings.get("bonfire_modern_harden");
            return false;
        }
        else if (order == "order_bonfire_rain_harden")
        {
            __result = AssetManager.buildings.get("bonfire_rain_harden");
            return false;
        }
        else if (order == "order_barracks_rain_harden")
        {
            __result = AssetManager.buildings.get("Barracks_rain_harden");
            return false;
        }
        else if (order == "order_house_rain_harden")
        {
            __result = AssetManager.buildings.get("House_rain_harden");
            return false;
        }
        else if (order == "order_market_harden")
        {
            __result = AssetManager.buildings.get("market_harden");
            return false;
        }
                else if (order == "order_bonfire_modern_horde")
        {
            __result = AssetManager.buildings.get("bonfire_modern_horde");
            return false;
        }
        else if (order == "order_bonfire_rain_horde")
        {
            __result = AssetManager.buildings.get("bonfire_rain_horde");
            return false;
        }
        else if (order == "order_barracks_rain_horde")
        {
            __result = AssetManager.buildings.get("Barracks_rain_horde");
            return false;
        }
        else if (order == "order_house_rain_horde")
        {
            __result = AssetManager.buildings.get("House_rain_horde");
            return false;
        }
        else if (order == "order_market_horde")
        {
            __result = AssetManager.buildings.get("market_horde");
            return false;
        }
